        ...
        switch (data) {
            ...
            case "Shot Put": {
                ...
                String shotput_rules="<HTML>\n" +
                        ...
                        "\n" +
                        "board approximately 4&quot; high at the front of the circle. <b>2.</b> The shot must land\n" +
                        "\n" +
                        "within an angle of approximately 30 degrees. <b>3.</b> The athlete must rest the\n" +
                        "\n" +
                        " shot in between the neck and shoulder and keep it tight to the neck\n" +
                        "\n" +
                        "while throwing. <b>4.</b> At the end of the throw, the thrower must push the\n" +
                        "\n" +
